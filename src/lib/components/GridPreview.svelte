      ...
      <section class="flex flex-col gap-2">
        ...
        <div class="flex flex-wrap items-start gap-1.5">
          {#each topHeroes as h (h.hero_id)}
            <div class="group flex w-[52px] flex-col items-center select-none" title="{h.name} • {pct2(h.winrate)} WR • {pct2(h.pickrate)} Pick">
              <div class="flex w-full flex-col items-center pb-0.5">
                <span class="font-sans text-[11px] font-bold tracking-tight text-[#e2e8f0] tabular-nums leading-tight">
                  {pct2(h.winrate)}
                </span>
                <span class="font-sans text-[9.5px] font-medium tracking-tight text-[#8e9aa8] tabular-nums leading-tight">
                  {pct2(h.pickrate)}
                </span>
              </div>

              <div
                class="relative h-[72px] w-[52px] overflow-hidden rounded-sm border border-[#2b3542] bg-[#10141a] shadow-[0_2px_6px_rgba(0,0,0,0.8)] transition-all group-hover:border-[#60a5fa] group-hover:shadow-[0_0_8px_rgba(96,165,250,0.3)]"
              >
                <img
