...
export const en = {
  ...
  settings: {
    ...
    grid_mode_merge: "Merge",
    grid_mode_separate_hint: "Create 5 standalone role grids",
    grid_mode_merge_hint: "Inject META block into one existing grid",
    merge_target: "Target grid",
    merge_target_hint: "META block is added into this grid, on the left",
    merge_target_placeholder: "Pick a grid…",
