export const en = {
  ...
  settings: {
    title: "Settings",
    meta_mode: "Data Source",
    meta_mode_matches: "Most Played",
    meta_mode_matches_hint: "Heroes sorted by match count",
    meta_mode_matches_wr: "High Winrate (>50%)",
    meta_mode_matches_wr_hint: "Meta heroes with positive winrate",
    meta_mode_d2ptrating: "D2PT Rating",
    meta_mode_d2ptrating_hint: "Ranked by Dota2ProTracker rating algorithm",
    grid_mode: "Grid Mode",
    grid_mode_separate: "Separate",
    grid_mode_merge: "Merged",
    grid_mode_separate_hint: "Writes all 6 D2PT hero grids",
    grid_mode_merge_hint: "Injects role meta into an existing grid",
    merge_target: "Target Grid",
    merge_target_hint: "Role meta will be injected into this grid, on the left",
...
export const ru = {
  ...
  settings: {
    title: "Настройки",
    meta_mode: "Источник данных",
    meta_mode_matches: "Популярные",
    meta_mode_matches_hint: "Герои по числу матчей",
    meta_mode_matches_wr: "Высокий винрейт (>50%)",
    meta_mode_matches_wr_hint: "Мета-герои с винрейтом выше 50%",
    meta_mode_d2ptrating: "Рейтинг D2PT",
    meta_mode_d2ptrating_hint: "Рейтинг по формуле Dota2ProTracker",
    grid_mode: "Режим грида",
    grid_mode_separate: "Отдельно",
    grid_mode_merge: "В существующий",
    grid_mode_separate_hint: "Записывает все 6 официальных сеток D2PT",
    grid_mode_merge_hint: "Вставляет категории ролей в существующий грид",
